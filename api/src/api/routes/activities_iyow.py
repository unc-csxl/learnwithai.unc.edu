...
"""IYOW-specific activity routes for the public API."""
...
router = APIRouter(prefix="/courses/{course_id}/activities/iyow", tags=["Activities"])
...
@router.get(
    ...
    response_model=list[IyowStudentSubmissionRow],
...
def list_iyow_submissions_roster(
    subject: AuthenticatedUserDI,
    course: CourseByCourseIDPathDI,
    activity: ActivityByPathDI,
    iyow_sub_svc: IyowSubmissionServiceDI,
) -> list[IyowStudentSubmissionRow]:
    ...
    results: list[IyowStudentSubmissionRow] = []
...
def get_iyow_active_submission(
    subject: AuthenticatedUserDI,
    course: CourseByCourseIDPathDI,
    activity: ActivityByPathDI,
    iyow_sub_svc: IyowSubmissionServiceDI,
...
def get_iyow_student_submission_history(
    subject: AuthenticatedUserDI,
    course: CourseByCourseIDPathDI,
    activity: ActivityByPathDI,
    student_pid: int,
