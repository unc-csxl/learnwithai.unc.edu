...
def test_main_creates_tables_and_seeds_demo_user() -> None:
    ...
    with (
        ...
        patch.object(module, "Session", return_value=session) as session_class_mock,
        patch.object(module, "get_engine") as get_engine_mock,
    ...
    session_class_mock.assert_called_once_with(get_engine_mock.return_value)
